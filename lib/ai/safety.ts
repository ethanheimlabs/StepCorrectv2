import type { SafetyAssessment } from "@/lib/types";
...
const DEFAULT_SUPPORT_MESSAGE =
  "This sounds heavier than a normal inventory. StepCorrect can help you pause, but this is the moment to get human support right away: call your sponsor, get near safe people, or use emergency services if anyone is in immediate danger.";
